...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/mwanon/bchd/integration/rpctest)
...
```bash
$ go get -u github.com/mwanon/bchd/integration/rpctest
```
