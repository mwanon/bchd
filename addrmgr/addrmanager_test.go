...
func addNaTests() {
	// IPv4
	// Localhost
	addNaTest("127.0.0.1", 8453, "127.0.0.1:8453")
	addNaTest("127.0.0.1", 8454, "127.0.0.1:8454")

	// Class A
	addNaTest("1.0.0.1", 8453, "1.0.0.1:8453")
	addNaTest("2.2.2.2", 8454, "2.2.2.2:8454")
	addNaTest("27.253.252.251", 8455, "27.253.252.251:8455")
	addNaTest("123.3.2.1", 8456, "123.3.2.1:8456")

	// Private Class A
	addNaTest("10.0.0.1", 8453, "10.0.0.1:8453")
	addNaTest("10.1.1.1", 8454, "10.1.1.1:8454")
	addNaTest("10.2.2.2", 8455, "10.2.2.2:8455")
	addNaTest("10.10.10.10", 8456, "10.10.10.10:8456")

	// Class B
	addNaTest("128.0.0.1", 8453, "128.0.0.1:8453")
	addNaTest("129.1.1.1", 8454, "129.1.1.1:8454")
	addNaTest("180.2.2.2", 8455, "180.2.2.2:8455")
	addNaTest("191.10.10.10", 8456, "191.10.10.10:8456")

	// Private Class B
	addNaTest("172.16.0.1", 8453, "172.16.0.1:8453")
	addNaTest("172.16.1.1", 8454, "172.16.1.1:8454")
	addNaTest("172.16.2.2", 8455, "172.16.2.2:8455")
	addNaTest("172.16.172.172", 8456, "172.16.172.172:8456")

	// Class C
	addNaTest("193.0.0.1", 8453, "193.0.0.1:8453")
	addNaTest("200.1.1.1", 8454, "200.1.1.1:8454")
	addNaTest("205.2.2.2", 8455, "205.2.2.2:8455")
	addNaTest("223.10.10.10", 8456, "223.10.10.10:8456")

	// Private Class C
	addNaTest("192.168.0.1", 8453, "192.168.0.1:8453")
	addNaTest("192.168.1.1", 8454, "192.168.1.1:8454")
	addNaTest("192.168.2.2", 8455, "192.168.2.2:8455")
	addNaTest("192.168.192.192", 8456, "192.168.192.192:8456")

	// IPv6
	// Localhost
	addNaTest("::1", 8453, "[::1]:8453")
	addNaTest("fe80::1", 8454, "[fe80::1]:8454")

	// Link-local
	addNaTest("fe80::1:1", 8453, "[fe80::1:1]:8453")
	addNaTest("fe91::2:2", 8454, "[fe91::2:2]:8454")
	addNaTest("fea2::3:3", 8455, "[fea2::3:3]:8455")
	addNaTest("feb3::4:4", 8456, "[feb3::4:4]:8456")

	// Site-local
	addNaTest("fec0::1:1", 8453, "[fec0::1:1]:8453")
	addNaTest("fed1::2:2", 8454, "[fed1::2:2]:8454")
	addNaTest("fee2::3:3", 8455, "[fee2::3:3]:8455")
	addNaTest("fef3::4:4", 8456, "[fef3::4:4]:8456")
}
...
func TestAttempt(t *testing.T) {
	...
	err := n.AddAddressByIP(someIP + ":8453")
	if err != nil {
...
func TestNeedMoreAddresses(t *testing.T) {
	...
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.%d.173.147:8453", i/128+60, i%128+60)
	...
	srcAddr := wire.NewNetAddressIPPort(net.IPv4(173, 144, 173, 111), 8453, 0)
...
func TestGood(t *testing.T) {
	...
	var err error
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.173.147.%d:8453", i/64+60, i%64+60)
		addrs[i], err = n.DeserializeNetAddress(s, wire.SFNodeNetwork)
		if err != nil {
			t.Errorf("Failed to turn %s into an address: %v", s, err)
		}
