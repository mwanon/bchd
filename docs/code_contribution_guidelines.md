...
reason, the mwanon suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire mwanon
...
commits](https://github.com/mwanon/bchd/commits/master) for examples of
commit messages.
...
Rejoice as you will now be listed as a [contributor](https://github.com/mwanon/bchd/graphs/contributors)!
...
[ISC license](https://github.com/mwanon/bchd/blob/master/LICENSE).  This is
the same license as all of the code in the mwanon suite.
