...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/mwanon/bchd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/mwanon/bchd/blockchain/fullblocktests
```
